...
function wp_spaios_slider_shortcode( $atts, $content = null) {
	...
	<div class="wp-spaios-slider-wrap wp-spaios-row-clearfix" data-conf="<?php echo htmlspecialchars(json_encode( $slider_conf )); ?>">
		<div class="wp-spaios-slider <?php echo esc_attr($slider_cls); ?>" id="<?php echo esc_attr($slider_id); ?>" style="<?php echo esc_attr($slider_style); ?>">
			...
			<div class="<?php echo esc_attr($slider_inr_cls); ?>">
						...
						while ( $query->have_posts() ) : $query->the_post();
							...
							if( $terms ) {
								foreach ( $terms as $term ) {
									...
									$term_links[]	= '<a href="' . esc_url( $term_link ) . '">'.wp_kses_post($term->name).'</a>';
								}
							}
