...
<figure>
	...
	<?php } else { ?>
		<img class="wp-spaios-slider-image" src="<?php echo esc_url( $image[0] ); ?>" alt="<?php echo esc_attr( $alt_text ); ?>" title="<?php echo esc_attr( $captions ); ?>" />
	<?php } if( $show_caption && $captions ) { ?>
		<figcaption>
			<h2 class="photostack-title"><?php echo esc_attr($captions); ?></h2>							
		</figcaption>
	<?php } ?>
</figure>